...
import br.com.fesfafic.qst1.Model.Animal.AnimalAquatico;

public class AmbienteAquatico extends Ambiente {
    public final double temperaturaCelsius;
    public final String tipoDeVegetacao;

    public AmbienteAquatico(String nome, double areaOcupada, int quantidadeDeAnimais, double temperaturaCelsius, String tipoDeVegetacao) {
    ...
    public void adicionarAnimal(Animal animal) {
        if (animal instanceof AnimalAquatico) {
