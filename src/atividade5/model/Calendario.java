...
public class Calendario {
    ...
    public final int numeroDeDias;

    public Calendario(int numeroDeEventos, int numeroDeDias) {
    ...
    public void inserirEvento(Organizador organizador, Evento evento) {
        if (evento.data.getDayOfMonth() > numeroDeDias) {
            System.out.println("Este calendário só suporta eventos marcados até o dia " + numeroDeDias);
            return;
        }
